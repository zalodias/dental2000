...
export function TestimonialQuote({
  ...
  return (
    <div
      className={cn(
        'mx-auto flex max-w-(--breakpoint-lg) flex-col items-center gap-8 text-center',
        className,
      )}
    >
      <svg
      ...
      <blockquote className="text-foreground-neutral-default text-title-large md:text-display-small font-medium">
        {quote}
      </blockquote>
      <div className="flex flex-col gap-1">
        <div className="text-body-large md:text-body-large text-foreground-neutral-default font-medium">
          {author}
        </div>
        <div className="text-body-large text-foreground-neutral-faded">
          {treatment}
        </div>
      </div>
    </div>
